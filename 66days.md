...
|---|---|---|---|---|---|---|
|07|02/07| - Dậy sớm **4:00** <br> - Chạy bộ <br> - Hít đất <br> - Làm LeetCode | - Làm Thesis <br> - Nghe Seminar | <details close><summary>Nghe</summary> - Tờ kinh số 6, 7 (&check; sáng) <br> - [Chopin](https://youtu.be/-gDinVAmtA0) </details> <details close><summary>Đọc</summary> - &check; **Đừng chạy theo số đông** (chương 1 - 40) </details> | - &check; Đo huyết áp cho ba | - Làm sao để proactive hơn và **demonstrate bản thân** tốt hơn, ok một vấn đề cần suy nghĩ và luyện tập lâu dài đây. <br> Tổng kết
| | | | | | | |
