...
|---|---|---|---|---|---|---|
|36|31/07| - &check; Dậy sớm **4:00** <br> - Chạy bộ `II` <br> - Hít đất `II` | - Đọc Neural Machine Translation `I` (chapter 11) <br> - Báo cáo Mentor  `I` | - Update CV
| | | | | | 
|35|30/07| - &check; Chạy bộ **2.00km/pace 5:33** <hr> - &cross; Dậy sớm &rarr; **trễ** | - &check; VNG Campus Tour &rarr; hehe team won được 3tr <br> - Đọc Neural Machine Translation `I` (chapter 10) | <details close><summary>Học Coursera</summary> - &check; Learning How to Learn: **Week 1** </details> <details close><summary>Đọc</summary> - Thiết kế cuộc đợi thịnh vượng `II` (chương 6, 100%) </details> | | - Hôm nay cần tập trung cao độ <br> - Ăn uống điều hòa, không nạp bậy bạ vào cơ thể
